jQuery(document).ready(function ($) {
  ...
  $("form").submit(function (event) {
    event.preventDefault(); // Mencegah formulir untuk melakukan submit secara langsung
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        $("#hasil-ongkir").html(
          '<div class="modal-header"><h1 class="modal-title fs-5" id="modalResiLabel">Hasil Ongkir</h1><button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button></div><div class="modal-body text-center" id="modalResiBody">' +
            response +
